...
public class Programe35 extends Employee{
	
	public Programe35(int id, String name, int age, String gender, String department, int yearOfJoining,
			double salary) {
	...
	public static void main(String[] args) {
		...
		int avgM = Mage/mcount;
		int avgF = Fage/fcount;
		System.out.println("Male: "+avgM+"Female: "+avgF);
