...
public class Programe42 extends Employee{
	
	public Programe42(int id, String name, int age, String gender, String department, int yearOfJoining,
			double salary) {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<al.size(); i++) {
			...
			totle = totle + ep.getSalary();
			avg = totle/al.size();
		}
		System.out.println("Avg: "+avg+"lpa Totle: "+totle+"lpa");
