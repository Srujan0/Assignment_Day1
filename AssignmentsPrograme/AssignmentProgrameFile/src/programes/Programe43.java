...
public class Programe43 extends Employee{
	
	public Programe43(int id, String name, int age, String gender, String department, int yearOfJoining,
			double salary) {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<al.size(); i++) {
			...
			if(ep.getAge() >= 25) {
				System.out.println("Older Than 25:"+ep.getName()+" age: "+ep.getAge()+"");
			}
		}
		for(int i=0; i<al.size(); i++) {
			Employee ep = (Employee)al.get(i);
			if(ep.getAge() <= 25) {
				System.out.println("Younger Than 25:"+ep.getName()+" age: "+ep.getAge()+"");
			}
		}
