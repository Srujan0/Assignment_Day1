...
public class Programe34 extends Employee{
	
	public Programe34(int id, String name, int age, String gender, String department, int yearOfJoining,
			double salary) {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<al.size(); i++) {
			...
			if(e.getSalary() >= maxSel) {
				maxSel = e.getSalary();
			}
		}
		
		System.out.println(maxSel);
